...
const Home: NextPage = () => {
  return (
    <div className="flex max-w-6xl mx-auto flex-col items-center justify-center py-2 min-h-screen">
      <Head>
        <title>RoomGPT Forked Version</title>
      </Head>

      <Header />
      <main className="flex flex-1 w-full flex-col items-center justify-center text-center px-4 sm:mt-20 mt-20 background-gradient">
        <a
          href="https://github.com/nerkoux/roomgpt"
          target="_blank"
          rel="noreferrer"
        ...
        >
          This is a forked repository from Github{" "}
          ...
          <div className="flex flex-col space-y-10 mt-4 mb-16">
            <div className="flex sm:space-x-8 sm:flex-row flex-col">
              <div>
                ...
                <Image
                  alt="Original photo of a room with roomGPT.akshatmehta.com"
              ...
              <div className="sm:mt-0 mt-8">
                ...
                <Image
                  alt="Generated photo of a room with roomGPT.akshatmehta.com"
                  width={400}
                  height={400}
